...
func (inst *Initialize) SetSourceChainAccount(sourceChain ag_solanago.PublicKey) *Initialize {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(sourceChain).WRITE()
	return inst
}

// GetSourceChainAccount gets the "sourceChain" account.
func (inst *Initialize) GetSourceChainAccount() *ag_solanago.AccountMeta {
...
func (inst *Initialize) SetOfframpAccount(offramp ag_solanago.PublicKey) *Initialize {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(offramp).WRITE()
	return inst
}
			...
			programBranch.Child(ag_format.Instruction("Initialize")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=5]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("referenceAddresses", inst.AccountMetaSlice.Get(1)))
						accountsBranch.Child(ag_format.Meta("           offramp", inst.AccountMetaSlice.Get(2)))

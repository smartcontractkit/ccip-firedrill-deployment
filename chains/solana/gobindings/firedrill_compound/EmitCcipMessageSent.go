...
func (inst *EmitCcipMessageSent) SetCompoundAccount(compound ag_solanago.PublicKey) *EmitCcipMessageSent {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(compound).WRITE()
	return inst
}

// GetCompoundAccount gets the "compound" account.
func (inst *EmitCcipMessageSent) GetCompoundAccount() *ag_solanago.AccountMeta {

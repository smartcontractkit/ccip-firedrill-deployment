...
func (inst *EmitCcipMessageSent) SetOnrampAccount(onramp ag_solanago.PublicKey) *EmitCcipMessageSent {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(onramp).WRITE()
	return inst
}

// GetOnrampAccount gets the "onramp" account.
func (inst *EmitCcipMessageSent) GetOnrampAccount() *ag_solanago.AccountMeta {
